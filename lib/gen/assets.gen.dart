...
class $AssetsBackgroundGen {
  ...
  /// File path: assets/background/onboarding.png
  AssetGenImage get onboarding =>
      const AssetGenImage('assets/background/onboarding.png');

  /// File path: assets/background/single_post.png
  AssetGenImage get singlePost =>
      const AssetGenImage('assets/background/single_post.png');
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/a-a.png
  AssetGenImage get aA => const AssetGenImage('assets/img/icons/a-a.png');

  /// File path: assets/img/icons/a.png
  AssetGenImage get a => const AssetGenImage('assets/img/icons/a.png');
  ...
  /// File path: assets/img/icons/h-a.png
  AssetGenImage get hA => const AssetGenImage('assets/img/icons/h-a.png');

  /// File path: assets/img/icons/h.png
  AssetGenImage get h => const AssetGenImage('assets/img/icons/h.png');

  /// File path: assets/img/icons/m-a.png
  AssetGenImage get mA => const AssetGenImage('assets/img/icons/m-a.png');

  /// File path: assets/img/icons/m.png
  AssetGenImage get m => const AssetGenImage('assets/img/icons/m.png');
  ...
  /// File path: assets/img/icons/s-a.png
  AssetGenImage get sA => const AssetGenImage('assets/img/icons/s-a.png');

  /// File path: assets/img/icons/s.png
  AssetGenImage get s => const AssetGenImage('assets/img/icons/s.png');
}
